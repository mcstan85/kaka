...
from MarkMusic.utils.database import get_authuser_names, get_cmode
from MarkMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from MarkMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Mark.stop_stream(message.chat.id)
    except:
        pass
