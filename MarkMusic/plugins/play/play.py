...
from MarkMusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from MarkMusic.core.call import Mark
from MarkMusic.utils import seconds_to_min, time_to_seconds
from MarkMusic.utils.channelplay import get_channeplayCB
from MarkMusic.utils.database import is_video_allowed
...
@app.on_callback_query(
    filters.regex("MarkPlaylists") & ~BANNED_USERS
)
@languageCB
