...
from MarkMusic.misc import HAPP, SUDOERS, XCB
from MarkMusic.utils.database import (get_active_chats,
                                       remove_active_chat,
        ...
        try:
            ...
            for x in served_chats:
                try:
                    ...
                    pass
            await response.edit(
                f"{nrs.text}\n\nᴏᴛ ᴜᴩᴅᴀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ ! ɴᴏᴡ ᴡᴀɪᴛ ғᴏʀ ғᴇᴡ ᴍɪɴᴜᴛᴇs ᴜɴᴛɪʟ ᴛʜᴇ ʙᴏᴛ ʀᴇsᴛᴀʀᴛs ᴀɴᴅ ᴩᴜsʜ ᴄʜᴀɴɢᴇs !"
            )
            os.system(
