...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        if 1==1:
            ...
            image4.text((10, 10), "CRAXY MUSIC", fill="white", font = font1, align ="left")
            image4.text((670, 150), "CRAXY PLAYER", fill="white", font = font2, stroke_width=2, stroke_fill="white", align ="left") 
